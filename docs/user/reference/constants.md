...
| Internal manifest schema version | `INTERNAL_MANIFEST_SCHEMA_VERSION = 13` | strict RFC-026 strand. V13 preserves v12 lifecycle-v3 authority and activates recovery-v15 for private resume/guarded drain-abort. V12 and older graphs require export/init/load rebuild |
...
| Recovery-sidecar schema ceiling | `SIDECAR_SCHEMA_VERSION = 15` | v15 activates exact hidden `StreamResume` for revision-fenced resume and guarded drain-abort, including its physical claim and terminal claim/management receipts. V14's three-field resume scaffold and its correction/retirement/ledger-maintenance/sealed-maintenance/rebind discriminators remain frozen and fail closed. Recovery-v13 remains exactly `StreamProfileChange`; historical recovery-v10 enrollment and recovery-v12 lifecycle-v2 fold meanings are not reinterpreted |

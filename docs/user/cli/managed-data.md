...
to a control-plane session or a named-server token. Automation can use an
origin-bound control credential to acquire identity credentials with an available

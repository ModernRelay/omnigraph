...
| `repair [--confirm] [--force]` | preview or explicitly publish uncovered manifest/head drift. `--confirm` heals verified maintenance drift; `--force --confirm` publishes suspicious/unverifiable drift after operator review |

...
**Surveyed:** OmniGraph 0.9.0 development, internal manifest schema v14,
Lance 9.0.0
...
drain-abort, and the narrow v14/recovery-v16 checked `SEALED` EnsureIndices
capability.
...
claim/management receipts before the sole `OPEN` publication. Current v14 adds
...
V14's older incomplete resume/maintenance/rebind scaffolds remain frozen.
...
retirement, Optimize/rebind integration, and public maintenance surfaces
...
private recovery-v15 resume/guarded drain-abort. Current v14 adds only the
recovery-v16 `SEALED` EnsureIndices capability. The next work is Optimize,
physical rebind, correction/retirement, and explicit
...
| [023 — Key-conflict fencing](../rfcs/0023-key-conflict-fencing.md) | **Implemented** | Internal schema v6 introduced exact-`id` PK metadata, closed keyed routing, typed conflicts, bounded replay, rebuild/refusal, and accepted performance evidence; v14 preserves that contract. |
...
| [026 — MemWAL streaming ingest](../rfcs/0026-memwal-streaming-ingest.md) | **Draft; private B2 token/fold, retain-all, profile-authority, hidden lifecycle, and narrow SEALED EnsureIndices tranches implemented; no public row path** | Schema v9 introduced config-v3/state-v2 token authority plus recovery-v12 exact base+token fold. V11/profile-v2 adds checked profile ownership, resumable `DISABLING`, and exact recovery-v13 `StreamProfileChange`. V12/lifecycle-v3 + recovery-v14 adds immutable enrollment/binding receipts, recovery-covered claims, exact ordinary/drain folds, and restartable hidden empty/non-empty quiescence. V13/recovery-v15 adds private resume and guarded drain-abort; current v14/recovery-v16 adds capability-only SEALED EnsureIndices; historical recovery-v10/v12/v14-resume/maintenance payloads are refused. Gate R0's no-go still prohibits a finite storage promise. Production enrollment/quiesce/resume/abort, correction/retirement, exclusive-cut physical status, Optimize/rebind, public row admission, and CLI/HTTP/OpenAPI surfaces remain inactive; B2b managed reclamation is optional future work. |
...
| [028 — Stable schema identity](../rfcs/0028-stable-schema-identity.md) | **Implemented** | Rename-stable IDs, table incarnation, identity-derived paths, schema/recovery integration, and strict rebuild activation were introduced in v5 and remain active in v14. |

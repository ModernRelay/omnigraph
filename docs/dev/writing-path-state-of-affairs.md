...
**Surveyed:** OmniGraph 0.9.0 development, internal manifest schema v16,
Lance 9.0.0
...
and v16/recovery-v18 checked offline physical rebind.
...
same atomic lifecycle-proof refresh. Current v16 adds recovery-v18 for an exact
...
authority. Public ingress/enrollment/quiesce/resume/abort, correction,
retirement, rebind, and maintenance surfaces remain inactive even though the
hidden one-lane lifecycle and private rebind cores now exist.
...
`SEALED` Optimize capability; current v16 adds the recovery-v18 private
physical-rebind capability. The next work is correction/retirement and explicit
...
| [023 — Key-conflict fencing](../rfcs/0023-key-conflict-fencing.md) | **Implemented** | Internal schema v6 introduced exact-`id` PK metadata, closed keyed routing, typed conflicts, bounded replay, rebuild/refusal, and accepted performance evidence; v16 preserves that contract. |
...
| [026 — MemWAL streaming ingest](../rfcs/0026-memwal-streaming-ingest.md) | **Draft; private B2 token/fold, retain-all, profile-authority, hidden lifecycle, narrow SEALED maintenance, and physical-rebind tranches implemented; no public row path** | Schema v9 introduced config-v3/state-v2 token authority plus recovery-v12 exact base+token fold. V11/profile-v2 adds checked profile ownership, resumable `DISABLING`, and exact recovery-v13 `StreamProfileChange`. V12/lifecycle-v3 + recovery-v14 adds immutable enrollment/binding receipts, recovery-covered claims, exact ordinary/drain folds, and restartable hidden empty/non-empty quiescence. V13/recovery-v15 adds private resume and guarded drain-abort; v14/recovery-v16 adds capability-only SEALED EnsureIndices; v15/recovery-v17 adds capability-only SEALED Optimize; current v16/recovery-v18 adds private exact-SEALED physical rebind. Historical recovery-v10/v12/v14-resume/maintenance/rebind payloads are refused. Gate R0's no-go still prohibits a finite storage promise. Production enrollment/quiesce/resume/abort/rebind, correction/retirement, exclusive-cut physical status, public row admission, and CLI/HTTP/OpenAPI surfaces remain inactive; B2b managed reclamation is optional future work. |
...
| [028 — Stable schema identity](../rfcs/0028-stable-schema-identity.md) | **Implemented** | Rename-stable IDs, table incarnation, identity-derived paths, schema/recovery integration, and strict rebuild activation were introduced in v5 and remain active in v16. |

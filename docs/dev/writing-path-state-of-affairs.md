...
**Surveyed:** OmniGraph 0.9.0 development, internal manifest schema v17,
Lance 9.0.0
...
v16/recovery-v18 checked offline physical rebind, and v17/recovery-v19
cluster-only terminal authority retirement and receipt-bearing export.
...
Current v17 adds recovery-v19 for the narrow stopped/offline, cluster-only
authority-retirement and receipt-bearing export exit.
...
authority. Public ingress/enrollment/quiesce/resume/abort, correction, rebind,
and maintenance surfaces remain inactive even though the hidden one-lane
lifecycle and private rebind cores now exist; retirement is the sole narrow
cluster-only CLI exception.
...
capability; current v17 adds recovery-v19 stopped/offline terminal authority
retirement and receipt-bearing export. The next work is correction and explicit
production contracts. B1's
...
| [023 — Key-conflict fencing](../rfcs/0023-key-conflict-fencing.md) | **Implemented** | Internal schema v6 introduced exact-`id` PK metadata, closed keyed routing, typed conflicts, bounded replay, rebuild/refusal, and accepted performance evidence; v17 preserves that contract. |
...
| [028 — Stable schema identity](../rfcs/0028-stable-schema-identity.md) | **Implemented** | Rename-stable IDs, table incarnation, identity-derived paths, schema/recovery integration, and strict rebuild activation were introduced in v5 and remain active in v17. |

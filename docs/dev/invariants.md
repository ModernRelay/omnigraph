...
- **Private B2 token/fold core and B2a retain-all profile are implemented;
  ...
  `AuthorityBlock` repair and F5's `DEAD_LETTERED` disposition remain future.

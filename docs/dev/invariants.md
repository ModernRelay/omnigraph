...
- **Private B2 token/fold core and B2a retain-all profile are implemented;
  ...
  evidence grammar exist. The F6b remainder still owns the dead-letter object/
  RSS and selected-token lookup measurements, bounded export transport, and

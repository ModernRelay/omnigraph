...
- **Private B2 token/fold core and B2a retain-all profile are implemented;
  ...
  RSS and selected-token lookup measurements, OS-process/fairness and lifecycle
  composition, bounded export transport, and the remaining guardrail matrix;

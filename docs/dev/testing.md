...
while `forbidden_apis.rs` proves no SDK row/control or CLI/HTTP/OpenAPI
streaming side door was introduced; it classifies the embedded read-only
`stream_status` surface separately.

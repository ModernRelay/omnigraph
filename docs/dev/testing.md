...
- in-source `stream_request` unit tests own the transport-neutral request
  ...
  CLI, API DTO, or OpenAPI ingress surface, and the hidden request still refuses
  F3 resume/rebind and any binding beyond the initial one;

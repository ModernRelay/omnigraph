...
- **Lance #6658 closed** (public `DeleteBuilder::execute_uncommitted`). Tracked as MR-A: migrate `delete_where` to staged, retire the parse-time D2 mutation rule, extend recovery sidecar coverage.

...
No heads-format production code ships from this RFC; current internal schema v16
...
- The current development format remains on internal schema v16 without table heads; no

...
No heads-format production code ships from this RFC; current internal schema v14
...
- The current development format remains on internal schema v14 without table heads; no

...
No heads-format production code ships from this RFC; current internal schema v18
...
- The current development format remains on internal schema v18 without table heads; no

...
No heads-format production code ships from this RFC; current internal schema v12
...
- Production remains on current internal schema v12 without table heads; no

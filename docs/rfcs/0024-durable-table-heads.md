...
No heads-format production code ships from this RFC; current internal schema v13
...
- The current development format remains on internal schema v13 without table heads; no

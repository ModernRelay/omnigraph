...
No heads-format production code ships from this RFC; current internal schema v15
...
- The current development format remains on internal schema v15 without table heads; no

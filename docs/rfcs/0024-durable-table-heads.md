...
No heads-format production code ships from this RFC; current internal schema v11
...
- Production remains on current internal schema v11 without table heads; no

...
No heads-format production code ships from this RFC; current internal schema v17
...
- The current development format remains on internal schema v17 without table heads; no

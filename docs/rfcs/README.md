...
The next available number is **0061**; lower gaps are historical and must
...
PR #662 for retained merged ancestry; 0059 by PR #675).
...
| [0060](0060-branch-ops-v2.md) | Branch operations v2 | maintainer | draft | not-started |

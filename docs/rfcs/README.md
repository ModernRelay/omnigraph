...
The next available number is **0057**; lower gaps are historical and must
not be reused (0047 and 0048 are allocated by PR #606; 0050 by the
`rfc/0050-engine-crate-topology` branch; 0055 by PR #626).
...
| [0056](0056-gq-one-language.md) | One language for every graph operation | maintainer | draft | not-started |

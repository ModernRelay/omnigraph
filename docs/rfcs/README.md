...
| [0066](0066-detached-table-commits.md) | Detached table commits | maintainer | draft | not-started |
| [0067](0067-graph-commit-record.md) | Graph commit record | maintainer | draft | not-started |

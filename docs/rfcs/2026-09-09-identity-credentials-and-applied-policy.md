...
## Provider-native access and standard clients

This extension replaces the opaque managed login/session brokerage described
in RFC 0052 with direct AuthKit public-client

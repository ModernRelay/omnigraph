...
- `crates/omnigraph-control-authority`: cycle-free persisted cluster-lock ownership plus opaque checked stopped/offline profile and served-runtime authority; retired export authority remains a later lifecycle slice

...
// Managed queries and mutations have a thirty-second total deadline.
// Loads retain their separate bounded receipt wait; neither retries implicitly.
const MANAGED_WRITE_TIMEOUT: std::time::Duration = std::time::Duration::from_secs(30);

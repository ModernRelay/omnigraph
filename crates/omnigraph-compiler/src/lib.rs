...
pub use catalog::schema_ir::{
    ...
    SCHEMA_IR_VERSION_FEATURES, SYSTEM_COLUMNS_LEGACY, SYSTEM_COLUMNS_V3, SchemaIR,
    SchemaIdentityDiagnostic, SchemaIdentityDiagnosticKind, SchemaIdentityDomain, SchemaResolution,
    StablePropertyId, StableTypeId, SystemColumns, SystemFieldRefIR, SystemFieldRole,
    TableIncarnationId, TypeRefIR, initialize_schema_ir, is_known_feature, is_supported_ir_version,
    required_features, required_ir_version, resolve_schema_ir, schema_ir_hash, schema_ir_json,
    schema_ir_pretty_json, schema_shape_from_ir, schema_shape_hash_from_ir,
    system_columns_for_features, validate_schema_ir,
};

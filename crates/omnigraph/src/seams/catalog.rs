...
omnigraph_seams::catalog! {
    ...
    crate::db::manifest::recovery::BRANCH_MERGE_PRE_ERROR_RECOVERY,
    crate::db::manifest::recovery::MUTATION_SIDECAR_CONFIRM_PUT,
    crate::db::manifest::recovery::MUTATION_SIDECAR_POST_PUBLISH_DELETE,
    crate::db::manifest::recovery::RECOVERY_BEFORE_ROLL_FORWARD_PUBLISH,
    crate::db::manifest::recovery::RECOVERY_ORPHAN_DISCARD_AUDIT_APPEND,
    crate::db::manifest::recovery::RECOVERY_POST_LIST_PRE_GATES,
    crate::db::manifest::recovery::RECOVERY_POST_ROLLBACK_PUBLISH_PRE_AUDIT,
    crate::db::manifest::recovery::RECOVERY_POST_SIDECAR_LIST_PRE_READ,
    crate::db::manifest::recovery::RECOVERY_POST_TABLE_RESTORE_PRE_PUBLISH,
    crate::db::manifest::recovery::RECOVERY_RECORD_AUDIT,
    crate::db::manifest::recovery::RECOVERY_SIDECAR_CONFIRM,
    crate::db::manifest::recovery::RECOVERY_SIDECAR_DELETE,
    crate::db::manifest::recovery::RECOVERY_SIDECAR_LIST,
    crate::db::manifest::recovery::RECOVERY_SIDECAR_WRITE,
    crate::db::manifest::recovery::SYSTEM_COLUMN_UPGRADE_AFTER_LOCK_RECLAIM,
    ...
    crate::db::omnigraph::BRANCH_CONTROL_POST_RECOVERY_BARRIER,
    ...
    crate::db::omnigraph::optimize::CLEANUP_POST_RECOVERY_CHECK_PRE_GATES,
    ...
    crate::db::omnigraph::optimize::OPTIMIZE_POST_COMPACT_PRE_REINDEX,
    crate::db::omnigraph::optimize::OPTIMIZE_POST_PHASE_B_PRE_MANIFEST_COMMIT,
    crate::db::omnigraph::optimize::OPTIMIZE_POST_RECOVERY_CHECK_PRE_MAIN_GATE,
    ...
    crate::db::omnigraph::table_ops::ENSURE_INDICES_POST_EFFECTS_PRE_CONFIRM,
    crate::db::omnigraph::table_ops::ENSURE_INDICES_POST_PHASE_B_PRE_MANIFEST_COMMIT,
    crate::db::omnigraph::table_ops::ENSURE_INDICES_POST_SIDECAR_PRE_FORK,
    ...
    crate::exec::merge::BRANCH_MERGE_POST_EFFECTS_PRE_CONFIRM,
    crate::exec::merge::BRANCH_MERGE_POST_PHASE_B_PRE_MANIFEST_COMMIT,
    crate::exec::merge::BRANCH_MERGE_POST_SIDECAR_PRE_FORK,
    ...
    crate::exec::staging::MUTATION_POST_ARM_PRE_EFFECT,

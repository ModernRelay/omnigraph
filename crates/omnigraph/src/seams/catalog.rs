...
omnigraph_seams::catalog! {
    ...
    crate::db::manifest::upgrade::UPGRADE_DETACHED_ONLY_BETWEEN_REAPS,
    ...
    crate::db::omnigraph::collector::CLEANUP_COLLECTOR_MID_BRANCH_READ,
    crate::db::omnigraph::collector::CLEANUP_COLLECTOR_POST_SNAPSHOT,
    crate::db::omnigraph::collector::CLEANUP_SWEEP_PRE_MANIFEST_DELETE,
    crate::db::omnigraph::collector::CLEANUP_SWEEP_BETWEEN_MANIFESTS,
    crate::db::omnigraph::collector::CLEANUP_SWEEP_PRE_FILE_DELETE,
}

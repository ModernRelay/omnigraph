...
pub(crate) use recovery::{
    ...
    RecoveryStreamOpenPlanV15, RecoveryStreamProtocolV14Scaffold,
    RecoveryStreamResumeOutcomeV15, RecoveryStreamResumeRequestV15,
    RecoveryTableUpdateSlot, SidecarKind, SidecarTablePin, SidecarTableRegistration,
    SidecarTableRename, SidecarTombstone,
    ...
    complete_stream_profile_change_sidecar_v13, confirm_branch_merge_sidecar_v9,
    ...
    confirm_stream_profile_change_sidecar_v13, confirm_stream_resume_sidecar_v15, delete_sidecar,
    ...
    new_schema_apply_sidecar_v9, new_stream_claim_sidecar_v14, new_stream_drain_fold_sidecar_v14,

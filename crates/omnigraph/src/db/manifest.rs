...
pub(crate) use recovery::{
    ...
    RecoverySidecarHandle, RecoveryStreamAdmissionScope, RecoveryStreamClaimAttemptV14,
    ...
    RecoveryStreamLifecycleReceiptV14, RecoveryStreamOpenPlanV15, RecoveryStreamProfileChangeKind,
    RecoveryStreamProtocolV14Scaffold, RecoveryStreamRebindOutcomeV18,
    RecoveryStreamResumeOutcomeV15,
    RecoveryStreamResumeRequestV15, RecoveryTableUpdateSlot, SidecarKind, SidecarTablePin,
    ...
    complete_stream_claim_sidecar_v14, complete_stream_enrollment_sidecar_v14,
    ...
    complete_stream_rebind_sidecar_v18, complete_stream_resume_sidecar_v15,
    confirm_branch_merge_sidecar_v9,
    confirm_ensure_indices_sidecar_v9, confirm_occ_sidecar_v9, confirm_schema_apply_sidecar_v9,
    confirm_stream_claim_sidecar_v14, confirm_stream_fold_sidecar_v12,
    confirm_stream_fold_sidecar_v14, confirm_stream_lifecycle_receipt_sidecar_v14,
    confirm_stream_profile_change_sidecar_v13, confirm_stream_resume_sidecar_v15,
    confirm_stream_sealed_ensure_indices_sidecar_v16,
    confirm_stream_sealed_optimize_sidecar_v17, delete_sidecar,
    ...
    new_stream_drain_fold_sidecar_v14, new_stream_enrollment_sidecar_v14,
    new_stream_fold_sidecar_v12, new_stream_fold_v2_sidecar_v14,
    ...
    new_stream_sealed_ensure_indices_sidecar_v16,
    new_stream_sealed_optimize_sidecar_v17,

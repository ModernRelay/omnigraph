...
pub mod names {
    ...
    /// RFC 0067 prototype: every detached table commit landed, the manifest
    ...
    /// RFC 0067 prototype: the manifest publication landed, promotion has not
    ...
    /// RFC 0067 prototype: after a promotion's existence check and before its

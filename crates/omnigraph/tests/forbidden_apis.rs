...
durable_calls! {
    ...
    ("db/manifest/recovery.rs", ".append(RecoveryAuditRecord", 15, WriteProtocol::RecoveryExecutor),
    ...
    ("db/manifest/recovery.rs", "delete_sidecar_by_operation_id(", 33, WriteProtocol::RecoveryExecutor),

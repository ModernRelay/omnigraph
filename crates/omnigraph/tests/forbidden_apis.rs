...
write_surfaces! {
    ...
    "exec/mutation.rs" => MUTATION_V9 => ["mutate", "mutate_as", "write_blob_at", "write_blob_at_as"],
...
const READ_ONLY_SURFACES: &[(&str, &str)] = &[
    ...
    ("db/omnigraph/blob_read.rs", "read_blob_at"),
...
gateway_surfaces! {
    ...
    "storage_layer.rs" => "TableStorage" => GatewayDisposition::ReadOrPure => [
        ...
        "first_row_id_for_filter", "first_row_id_for_id", "table_state", "has_btree_index",
    ...
    "table_store.rs" => "TableStore" => GatewayDisposition::ReadOrPure => [
        ...
        "scan_with_pending_materialized_blobs_skipping", "count_rows_with_staged",
...
durable_calls! {
    ...
    ("db/omnigraph/blob_read.rs", ".into_arc()", 1, WriteProtocol::ReadOnlyAccess),

...
durable_calls! {
    ...
    ("db/omnigraph.rs", "heal_pending_sidecars_roll_forward(", 1, WriteProtocol::RecoveryExecutor),
    ("db/omnigraph.rs", "recover_schema_state_files(", 1, WriteProtocol::RecoveryExecutor),

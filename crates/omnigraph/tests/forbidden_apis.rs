...
durable_calls! {
    ...
    ("db/manifest/recovery.rs", "delete_sidecar(", 2, WriteProtocol::Composed("recovery executor + delete_sidecar_after_publish, the Mutation/Load v9 post-publish adapter tail behind the mutation.sidecar_post_publish_delete seam")),

...
durable_calls! {
    ...
    ("db/omnigraph/promotion.rs", ".promote_detached(", 2, WriteProtocol::Exact("RFC 0067 promotion replay")),
    ...
    ("db/manifest/recovery.rs", ".write_text(", 5, WriteProtocol::RecoveryExecutor),
    ...
    ("db/manifest/recovery.rs", "delete_sidecar_by_operation_id(", 20, WriteProtocol::RecoveryExecutor),
        ("db/manifest/recovery.rs", "delete_sidecar(", 1, WriteProtocol::Composed("recovery executor")),
